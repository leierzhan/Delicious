    		...
    		***************************************/
    	    ...
    	    function onComplete(data) {
    	    	...
    	    	$.ajax({
                    ...
                    data:{"latitude":data.position.getLat(),"longitude":data.position.getLng(),"data":new Date()},
  ...
  <body style="margin:0px auto;">
   ...
   <div class="content">
     ...
     <div style="height:50px;">
       <span style="float:left;position:relative;left:16px;top:50%;transform:translateY(-50%);">定位：<span class="position" style="color:#7763D5;"></span></span>
     </div>
