...
<body style="background-color: #eee;">
 <header class="bar bar-nav">
   <button class="button pull-left go" title="../merchant/goAddChef">
      首页
    </button>
    <button class="button pull-right go" title="../merchant/goAddGreensByChef">
      +
    </button>
	...
	<div class="content" style="margin-top:-40px;">
		<div class="list-block media-list">
			...
			<c:forEach items="${grs}" var="g" >
				<li><a href="../merchant/goChefUpdateGreens?id=${g.id}" class="item-link item-content">
