...
//    	int userId=userService.getUserIdByOpenId(openId);
    ...
    public String articleOauthUserInfoH5(HttpServletRequest request,@RequestParam("code") String code,
    		Map<String,Object> map,RedirectAttributes attr,HttpSession session){
		OauthAccessToken accessToken=AdvancedUtil.getOauthAccessToken(code);
		if(accessToken!=null){
			session.setAttribute("openId",accessToken.getOpenId());
		}
