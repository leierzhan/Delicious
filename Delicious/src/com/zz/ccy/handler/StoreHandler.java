...
public class StoreHandler {
	...
	public String storeList(@ModelAttribute("userId") Integer userId,Map<String,Object> map){
    ...
    public String storeDetailUI(@RequestParam("storeId") int storeId,@RequestParam("userId") Integer userId,Map<String,Object> map){
    	...
    	//根据店铺id获取厨师
    	List<ChefEntity> chefEntityList=storeService.getChefByStoreId(storeId);
